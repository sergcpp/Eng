...
void test_upscaling(Sys::ThreadPool &threads) {
    ...
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   std::vector<double>{24.15, 24.00, 23.70, 23.60, 22.90, 22.90, 22.75, 22.70, 22.50, 22.40, //
                                       22.20, 22.05, 21.95, 21.90, 21.70, 21.80, 21.70, 21.80, 21.80, 22.00,
                                       21.90, 22.00, 22.00, 22.15, 22.10, 21.95, 22.15, 22.05, 22.40, 22.75,
                                       22.85, 22.95, 23.10},
                   MedDiffGI, 2.0f);
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   std::vector<double>{22.75, 22.70, 22.60, 22.60, 22.55, 22.50, 22.40, 22.45, 22.35, 22.25, //
                                       22.05, 22.10, 22.05, 21.95, 21.85, 21.90, 21.95, 22.05, 21.95, 22.05,
                                       22.20, 22.25, 22.25, 22.25, 22.15, 22.20, 22.25, 22.45, 22.60, 22.70,
                                       22.90, 22.95, 23.00},
                   Full, 1.5f);
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   std::vector<double>{23.75, 23.65, 23.50, 23.45, 23.25, 23.15, 23.00, 22.95, 22.85, 22.75, //
