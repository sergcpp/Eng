...
void test_upscaling(Sys::ThreadPool &threads) {
    ...
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   std::vector<double>{23.70, 23.65, 23.40, 23.35, 22.90, 22.90, 22.70, 22.55, 22.35, 22.15, //
                                       21.95, 21.85, 21.75, 21.70, 21.50, 21.60, 21.50, 21.60, 21.60, 21.75,
    ...
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   ...
                   Full, 1.5f);
    run_image_test(ren_ctx, threads, "upscaling_dyn",
                   std::vector<double>{23.60, 23.55, 23.35, 23.25, 23.05, 22.90, 22.75, 22.70, 22.60, 22.55, //
                                       22.35, 22.35, 22.30, 22.25, 22.10, 22.25, 22.15, 22.25, 22.10, 22.15,
                                       22.15, 22.30, 22.30, 22.25, 22.05, 22.10, 22.15, 22.25, 22.40, 22.50,
                                       22.65, 22.80, 22.85},
                   Full_Ultra, 1.5f);
}
