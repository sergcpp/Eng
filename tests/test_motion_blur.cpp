...
void test_motion_blur(Sys::ThreadPool &threads) {
    ...
    run_image_test(ren_ctx, threads, "motion_blur_dyn",
                   std::vector<double>{23.80, 24.45, 24.35, 24.30, 24.15, 24.05, 23.90, 23.80, 23.60, 23.50, //
                                       23.25, 23.15, 23.05, 23.00, 22.85, 22.95, 22.85, 22.95, 22.95, 23.10,
                                       23.30, 23.45, 23.55, 23.75, 23.70, 23.90, 24.15, 24.45, 24.70, 24.95,
                                       25.05, 25.30, 24.50},
                   MedDiffGI_MotionBlur, 1.5f);
    run_image_test(ren_ctx, threads, "motion_blur_dyn",
                   std::vector<double>{22.65, 23.20, 23.20, 23.20, 23.15, 23.15, 23.10, 23.15, 23.05, 23.00, //
                                       22.85, 22.80, 22.75, 22.70, 22.60, 22.75, 22.60, 22.70, 22.75, 22.90,
                                       23.10, 23.30, 23.35, 23.50, 23.45, 23.60, 23.85, 24.15, 24.35, 24.55,
                                       24.65, 24.90, 24.15},
