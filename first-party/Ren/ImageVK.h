...
class Image : public RefCounter {
    ...
    void InitFromRAWData(const BufferMain *sbuf_main, const BufferCold *sbuf_cold, int data_off, CommandBuffer cmd_buf,
                         MemAllocators *mem_allocs, const ImgParams &p, ILog *log);
    void InitFromRAWData(const BufferMain *sbuf_main, const BufferCold *sbuf_cold, int data_off[6],
  ...
  public:
    ...
    Image() = default;
    Image(std::string_view name, ApiContext *api, const ImgParams &params, MemAllocators *mem_allocs, ILog *log);
    Image(std::string_view name, ApiContext *api, const ImgHandle &handle, const ImgParams &_params,
    ...
    ApiContext *api() const { return api_; }
...
void ClearImage(const Image &img, const ClearColor &col, CommandBuffer cmd_buf);
