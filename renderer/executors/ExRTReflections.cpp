    ...
    if (!initialized_) {
        ...
        if (args_->four_bounces) {
            ...
            if (args_->irradiance_tex) {
                pi_rt_reflections_[0] = sh.FindOrCreatePipeline(hwrt_select(
                ...
                pi_rt_reflections_[0] = sh.FindOrCreatePipeline(
            ...
            pi_rt_reflections_[1] = sh.FindOrCreatePipeline(hwrt_select(
                subgroup_select(
...
void Eng::ExRTReflections::Execute_SWRT(const FgContext &fg) {
    ...
    Ren::SmallVector<Ren::Binding, 24> bindings = {
        ...
        {Ren::eBindTarget::UTBuf, RTReflections::BLAS_BUF_SLOT, rt_blas},
        ...
        {Ren::eBindTarget::UTBuf, RTReflections::MESH_INSTANCES_BUF_SLOT, mesh_instances},
